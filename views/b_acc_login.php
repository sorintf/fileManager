			...
			<div class="card card-form">
				<form action="" method="post" class="needs-validation" novalidate>
					<div class="form-input">
						<label for="login-username" class="form-label">Email/Telefon</label>
						<div class="input-group has-validation">
							<input type="text" class="form-control <?php echo isset($baseFunctions->rep['errors']['username'])?$baseFunctions->rep['errors']['username']:''; ?>" id="login-username" name="login-username" value="<?php echo isset($baseFunctions->rep['username'])?$baseFunctions->rep['username']:''; ?>" placeholder="Email/Telefon/E-mail" required>
				...
				<div class="card-footer">
					Don't have an account? <a href="<?php echo $baseFunctions->buildUrl(array('view'=>"b_acc_register")); ?>" class="">Register now!</a>
				</div>
			</div>
		</div>
	</div>
