            ...
            <div class="navbar-content">
                ...
                <ul class="pc-navbar">
                    ...
                    <li class="pc-item pc-hasmenu <?php echo (strpos($adminFunctions->view, "a_files")!==false)?'active pc-trigger':''; ?>">
                        ...
                        <!-- <ul class="pc-submenu">
                            <li class="pc-item <?php echo ($adminFunctions->view==="a_files_clients_add")?'active':''; ?>">
                                <a class="pc-link" href="<?php echo $adminFunctions->buildUrl(array('view'=>'a_files_clients_add')); ?>">
                                    <span class="pc-mtext">Adauga</span>
                                </a>
                            </li>
                        </ul> -->
                    </li>
